# -*- coding: utf-8 -*-
"""
Created on Tue Aug 13 11:34:06 2019
...
## HARALICK ##
def haralick(img):
    feat = mt.features.haralick(img, distance = 1, ignore_zeros = True).reshape(1, -1)
    return feat
...
for train_name in train_names:
    ...
    for file in glob.glob(cur_path + "\*.jpg"):
        ...
        global_features = np.hstack([haralick_features, huMoments_features, histogram_features])
...
for file in glob.glob(test_path + "\*.jpg"):
    ...
    # show the label
    cv.putText(image, str(prediction), (20, 30), cv.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 255), 3)
